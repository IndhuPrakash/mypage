...
if (isset($_POST['submit']))
{
	...
	$mobile=$_POST['mobile'];
	$dob=$_POST['dob'];
	$query = "INSERT INTO student (first_name,last_name,roll_no,dept,email,pwd,gender,mobile,dob) 
		VALUES('$first_name','$last_name','$roll_no','$dept','$email','$pwd','$gender','$mobile','$dob')";
